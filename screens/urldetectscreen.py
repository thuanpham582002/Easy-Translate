...
def url_translate(url):
    if screens.constant.source_language == 'Detect language' == screens.constant.destination_language:
        return url
    return 'http://translate.google.com/translate?js=n&sl=' + screens.constant.list_language_dict[screens.constant.source_language] + '&tl=' + screens.constant.list_language_dict[screens.constant.destination_language] + '&u=' + url
